...
enum class CommandType {
    ...
    DRFMb, // [DRFM] DRFM Bank
    DRFMsb, // [DRFM] DRFM Same Bank
    DRFMab, // [DRFM] DRFM All Bank
    PREab,
    PREsb,
    SIZE
};
...
struct Command {
    ...
    bool IsDRFM() const {
        return cmd_type == CommandType::DRFMab || cmd_type == CommandType::DRFMsb ||
               cmd_type == CommandType::DRFMb;
    }
    ...
    bool IsSbCMD() const {
        return cmd_type == CommandType::RFMsb ||
               cmd_type == CommandType::REFsb ||
               cmd_type == CommandType::DRFMsb ||
               cmd_type == CommandType::PREsb;
    }
    ...
    bool IsRankCMD() const {
        return cmd_type == CommandType::REFab ||
               ...
               cmd_type == CommandType::DRFMab ||
                cmd_type == CommandType::PREab;
    }
